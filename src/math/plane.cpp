...
// static
Plane Plane::fromPoints(const glm::vec4& a, const glm::vec4& b, const glm::vec4& c) {
...
// static
Plane Plane::fromDirections(const glm::vec4& p, const glm::vec4& d1, const glm::vec4& d2) {
