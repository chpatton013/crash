...
/* static */ Plane Plane::fromPoints(const glm::vec3& a, const glm::vec3& b, const glm::vec3& c) {
   glm::vec3 v = b - a;
   glm::vec3 w = c - b;
...
/* static */ Plane Plane::fromPoints(const glm::vec4& a, const glm::vec4& b, const glm::vec4& c) {
   return Plane::fromPoints(glm::vec3(a), glm::vec3(b), glm::vec3(c));
}

/* static */ Plane Plane::fromDirections(const glm::vec3& p, const glm::vec3& d1, const glm::vec3& d2) {
   return Plane(p, glm::normalize(glm::cross(d1, d2)));
}

/* static */ Plane Plane::fromDirections(const glm::vec4& p, const glm::vec4& d1, const glm::vec4& d2) {
